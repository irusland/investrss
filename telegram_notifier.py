...
class TelegramNotifier:
    def __init__(self, telegram_notifier_settings: TelegramNotifierSettings):
        ...
        self._send_message_url = f'https://api.telegram.org/bot{self._settings.token}/sendMessage'

    async def send_message(self, message, parse_mode='HTML'):
        data = {
            'chat_id': self._settings.chat_id, 'text': message, 'parse_mode': parse_mode
        }
